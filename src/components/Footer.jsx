...
const Footer = () => {
  return (
    <footer className="w-full padding-0">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex justify-between flex-wrap flex-row">
          <div className="">
            <p className="pb-2 text-lg text-gray-500 lg:max-w-xs text-center lg:text-left">
              Связаться с нами
            </p>
            <div className="flex justify-center gap-2">
              <a
                href="#"
                className="w-9 h-9 rounded-full bg-slate-500 flex justify-center items-center hover:bg-orange-600"
              >
                <svg
          ...
          <div className="lg:mx-auto text-center sm:text-left">
            <h4 className="text-lg text-gray-900 font-medium mb-7">КАТАЛОГ</h4>
            <ul className="text-sm  transition-all duration-500">
              <li className="mb-6">
                <a href="#" className="text-gray-600 hover:text-gray-900">
                  Категория 1
          ...
          <div className="lg:mx-auto text-center text-xs sm:text-left basis-1/3">
            <h4 className=" text-gray-600 font-medium mb-7">
              © 2024 Мой магазин
            </h4>
            <div>
              <a
        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span className="text-sm text-gray-500 ">
              ©<a href="https://pagedone.io/">Мой магазин</a>
            </span>
